classdef filter_single_delay < INS_GRC
% 估计惯导延迟
    ...
    methods
        %% 构造函数
        function obj = filter_single_delay(para)
            %----惯导初始化------------------
            para_ins.p0 = para.p0;
            para_ins.v0 = para.v0;
            para_ins.a0 = para.a0;
