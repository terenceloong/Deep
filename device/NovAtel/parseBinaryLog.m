...
'VariableNames',{'solState','posType','lat','lon','h','undulation',...
...
'VariableNames',{'P_solState','posType','X','Y','Z','Xsigma','Ysigma','Zsigma',...
...
'VariableNames',{'clockStatus','offset','offsetSigma','UTCoffset','UTCyear',...
...
'VariableNames',{'solState','posType','length','heading','pitch','headingSigma','pitchSigma',...
