...
a = 1/0.003; %时延的倒数
H1 = tf([K1+a,K1*a+K2,K2], [1,K1+a,K1*a+K2,K2]);
a = 1/0.006;
H2 = tf([K1+a,K1*a+K2,K2], [1,K1+a,K1*a+K2,K2]);
a = 1/0.01;
H3 = tf([K1+a,K1*a+K2,K2], [1,K1+a,K1*a+K2,K2]);
...
set(ax, 'YLim',[-32,5])
ylabel('幅值/(dB)')
legend('3ms','6ms','10ms','无辅助', 'Location','southwest')
