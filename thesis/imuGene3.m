...
if ~exist('imuGene_GUIflag','var') || imuGene_GUIflag~=1
    ...
    imuGene_conf.gyroSigma = 0.05*1; %陀螺仪噪声标准差,deg/s
    imuGene_conf.accSigma = 0.006*1; %加速度计噪声标准差,m/s^2
    imuGene_conf.gyroInstab = 0.0028*1; %陀螺仪零偏不稳定性,deg/s
    imuGene_conf.accInstab = 0.00015*1; %加速度计零偏不稳定性,m/s^2
    imuGene_conf.trajName = 'traj202'; %轨迹名
end
...
gyroInstab = imuGene_conf.gyroInstab; %陀螺仪零偏不稳定性,deg/s
accInstab = imuGene_conf.accInstab; %加速度计零偏不稳定性,m/s^2
