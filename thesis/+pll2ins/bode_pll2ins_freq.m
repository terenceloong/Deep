...
a = 1/0.003; %时延的倒数
H1 = tf([a,K1*a+K2,K2*a], [1,K1+a,K1*a+K2,K2*a]);
a = 1/0.006;
H2 = tf([a,K1*a+K2,K2*a], [1,K1+a,K1*a+K2,K2*a]);
a = 1/0.01;
H3 = tf([a,K1*a+K2,K2*a], [1,K1+a,K1*a+K2,K2*a]);
...
set(ax, 'YLim',[-40,5])
ylabel('幅值/(dB)')
legend('二阶环','3ms','6ms','10ms', 'Location','southwest')
